...
public class MainActivity extends AppCompatActivity {
    ...
    public void onStart(){
        ...
        DB.getInstance().getAuctions(item -> manageAdapterItem(item, mAuctionsAdapter, mLstAuctions, mTxtMsgAuctions, R.string.no_auctions));
    }
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.popup_quit_yes, new DialogInterface.OnClickListener(){
                    @Override
